...
CFLAGS=-g -O2 -mlittle-endian -mthumb -mfloat-abi=softfp -mfpu=fpv4-sp-d16
...
#Source Files
SRC += main.c system_stm32f4xx.c stm32f4xx_it.c usart3.c string.c L3G4200D.c ws_spi.c
